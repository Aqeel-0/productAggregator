...
class Category extends Model {
  ...
  /**
   * Enhanced category lookup with caching and statistics
   * Used by DatabaseInserter for optimized category retrieval
   */
  static async getCategoryForProduct(productData, cache, stats) {
    ...
    try {
      ...
      if (category) {
        ...
        // Fallback to smartphones category
